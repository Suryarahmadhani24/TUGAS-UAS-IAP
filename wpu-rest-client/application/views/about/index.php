      ...
      <section class="portfolio" id="portfolio">
          <div class="row">
            <div class="col-md mb-4">
              <div class="card">
                <img class="card-img-top" src="<?= base_url(); ?>assets/img/thumbs/JSON.png" alt="Card image cap">
                <div class="card-body">
                  <h5>JSON</h5>
            ...
            <div class="col-md mb-4">
              <div class="card">
                <img class="card-img-top" src="<?= base_url(); ?>assets/img/thumbs/hut.png" alt="Card image cap">
                <div class="card-body">
                  <h5>WPU-HUT</h5>
            ...
            <div class="col-md mb-4">
              <div class="card">
                <img class="card-img-top" src="<?= base_url(); ?>assets/img/thumbs/movie.png" alt="Card image cap">
                <div class="card-body">
                  <h5>WPU-MOVIE</h5>
          ...
          <div class="row">
            <div class="col-md mb-4">
              <div class="card">
                <img class="card-img-top" src="<?= base_url(); ?>assets/img/thumbs/portofolio.png" alt="Card image cap">
                <div class="card-body">
                  <h5>WPU-PORTFOLIO</h5>
            ...
            <div class="col-md mb-4">
              <div class="card">
                <img class="card-img-top" src="<?= base_url(); ?>assets/img/thumbs/server.png" alt="Card image cap">
                <div class="card-body">
